...
- [ ] T001 Verify Zustand store structure in app/store/todos.ts
- [ ] T002 Verify existing Toggle component in app/components/ui/toggle.tsx
- [ ] T003 Verify lucide-react Hash icon is available (import test)
- [ ] T004 Review existing Settings component structure in app/components/Settings.tsx
...
- [ ] T005 [P] Extend TodosState interface with showOverallCount and showQuadrantCounts in app/store/todos.ts
- [ ] T006 [P] Implement store actions setShowOverallCount and setShowQuadrantCounts in app/store/todos.ts
- [ ] T007 [P] Create reusable TaskCountBadge component in app/components/TaskCountBadge.tsx
- [ ] T008 Verify store defaults (showOverallCount: false, showQuadrantCounts: false) persist correctly
...
- [ ] T009 [US1] Add "Tasks" section header in Settings modal in app/components/Settings.tsx
- [ ] T010 [US1] Add divider between General and Tasks sections in app/components/Settings.tsx
- [ ] T011 [US1] Add "Show Overall Total" toggle to Tasks section in app/components/Settings.tsx
- [ ] T012 [US1] Add "Show Per-Quadrant Totals" toggle to Tasks section in app/components/Settings.tsx
- [ ] T013 [US1] Connect toggles to store actions (setShowOverallCount, setShowQuadrantCounts) in app/components/Settings.tsx
- [ ] T014 [US1] Verify both toggles default to OFF state when Settings opens
- [ ] T015 [US1] Test toggle state persistence (enable toggles, refresh page, verify state retained)
- [ ] T016 [US1] Test accessibility: keyboard navigation (Tab, Space) through new toggles
- [ ] T017 [US1] Verify Settings modal layout remains clean with new Tasks section on mobile (320px width)
...
- [ ] T018 [P] [US2] Create OverallTaskCount component in app/components/OverallTaskCount.tsx
- [ ] T019 [US2] Implement useMemo to compute overall count (all active tasks) in app/components/OverallTaskCount.tsx
- [ ] T020 [US2] Implement useMemo to compute Q1 count (urgent + important active tasks) in app/components/OverallTaskCount.tsx
- [ ] T021 [US2] Add conditional logic: show Q1 count when isFocus=true, otherwise overall in app/components/OverallTaskCount.tsx
- [ ] T022 [US2] Return null when showOverallCount is false in app/components/OverallTaskCount.tsx
- [ ] T023 [US2] Render TaskCountBadge with computed count and appropriate label in app/components/OverallTaskCount.tsx
- [ ] T024 [US2] Modify FocusControls layout to use justify-between in app/components/FocusControls.tsx
- [ ] T025 [US2] Add OverallTaskCount component to right side of FocusControls in app/components/FocusControls.tsx
- [ ] T026 [US2] Test: Enable overall count, add task to Q1, verify count increments
- [ ] T027 [US2] Test: Complete task, verify count decrements immediately
- [ ] T028 [US2] Test: Move task between quadrants, verify overall count remains same
- [ ] T029 [US2] Test: Zero tasks scenario - verify displays "0" (not hidden)
- [ ] T030 [US2] Test: Enter focus mode with overall count enabled, verify shows Q1 count only
- [ ] T031 [US2] Test: Exit focus mode, verify count returns to overall total
- [ ] T032 [US2] Test: Responsive layout - verify count fits on 320px mobile width
- [ ] T033 [US2] Test: Dark mode - verify count badge uses correct theme colors
...
- [ ] T034 [P] [US3] Add quadrantId prop to Quadrant component interface in app/components/Quadrant.tsx
- [ ] T035 [P] [US3] Add tasks prop to Quadrant component interface in app/components/Quadrant.tsx
- [ ] T036 [US3] Read showQuadrantCounts and isFocus from store in app/components/Quadrant.tsx
- [ ] T037 [US3] Implement useMemo to compute count for this quadrant based on quadrantId in app/components/Quadrant.tsx
- [ ] T038 [US3] Add conditional logic: hide count in focus mode unless quadrantId is q1 in app/components/Quadrant.tsx
- [ ] T039 [US3] Modify header to use justify-between layout in app/components/Quadrant.tsx
- [ ] T040 [US3] Render TaskCountBadge in header right side when shouldShowCount is true in app/components/Quadrant.tsx
- [ ] T041 [US3] Update Q1 Quadrant usage in page to pass quadrantId="q1" and tasks array in app/page.tsx
- [ ] T042 [US3] Update Q2 Quadrant usage in page to pass quadrantId="q2" and tasks array in app/page.tsx
- [ ] T043 [US3] Update Q3 Quadrant usage in page to pass quadrantId="q3" and tasks array in app/page.tsx
- [ ] T044 [US3] Update Q4 Quadrant usage in page to pass quadrantId="q4" and tasks array in app/page.tsx
- [ ] T045 [US3] Test: Enable per-quadrant counts, verify all 4 quadrants show counts
- [ ] T046 [US3] Test: Add task to Q2, verify only Q2 count increments
- [ ] T047 [US3] Test: Move task Q1 to Q3, verify Q1 decrements and Q3 increments
- [ ] T048 [US3] Test: Complete task in Q4, verify Q4 count decrements
- [ ] T049 [US3] Test: Empty quadrant displays "0" (not hidden)
- [ ] T050 [US3] Test: Responsive - verify counts don't break quadrant layout on mobile
...
- [ ] T051 [P] [US4] Verify OverallTaskCount switches to Q1 count when isFocus is true (implementation already in T021)
- [ ] T052 [P] [US4] Verify Quadrant hides Q2, Q3, Q4 counts when isFocus is true (implementation already in T038)
- [ ] T053 [US4] Test: Enable overall count, enter focus mode, verify header shows Q1 count only
- [ ] T054 [US4] Test: Enable per-quadrant counts, enter focus mode, verify only Q1 quadrant shows count
- [ ] T055 [US4] Test: Both counts enabled, enter focus mode, verify only one count visible (Q1)
- [ ] T056 [US4] Test: In focus mode with counts, add task to Q1, verify count increments
- [ ] T057 [US4] Test: Exit focus mode, verify overall count returns to total (not Q1)
- [ ] T058 [US4] Test: Exit focus mode, verify Q2, Q3, Q4 quadrant counts reappear
- [ ] T059 [US4] Test: Toggle focus mode multiple times, verify counts consistently update
...
- [ ] T060 [P] Verify aria-labels on all count displays for screen reader accessibility
- [ ] T061 [P] Test: Count badge color contrast meets WCAG AA in both light and dark themes
- [ ] T062 Test: Rapid task operations (add 10 tasks quickly), verify counts update correctly
- [ ] T063 Test: Complete all tasks, verify all counts show "0" simultaneously
- [ ] T064 Test: Both toggles ON + both OFF combinations, verify correct visibility
- [ ] T065 Test: Page load performance - verify count computation doesn't delay render
- [ ] T066 Test: DevTools Performance tab - verify count updates complete in <100ms
- [ ] T067 Test: Browser back/forward navigation preserves toggle states
- [ ] T068 Test: Multiple browser tabs, change setting in one, refresh other, verify persistence
- [ ] T069 Visual review: Verify count badges follow "Calm Design" principle (subtle, non-intrusive)
- [ ] T070 Visual review: Verify Hash icon renders correctly at 14px size
- [ ] T071 Verify no TypeScript errors in modified files (run tsc --noEmit)
- [ ] T072 Verify no ESLint warnings in new/modified files (run pnpm lint)
- [ ] T073 Final constitution check: Verify all 6 principles satisfied
